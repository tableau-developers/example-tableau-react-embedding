        ...
        buildRelativeDateFilterCommandParams: function (e, bi) {
          ...
          if (ss.isValue(bi)) {
            ...
            if (ss.isValue(bi.anchorDate)) {
              bj['api.filterDateArchorValue'] = p.serializeDateForServer(
                bi.anchorDate
              );
            }
          }
    ...
    var c = (global.tab._CustomViewImpl = ss.mkType(
      ...
      },
      {
        ...
        saveAsync: function () {
          ...
          var bo = c.$0(
            ...
            ss.mkdel(this, function (bp) {
              c._processCustomViewUpdate(this.$j, this.$e, bp, true);
              e.resolve(this.$3());
            })
          );
        ...
        $0: function () {
          ...
          var bo = c.$0(
            ...
            ss.mkdel(this, function (bp) {
              this.$d = true;
              c._processCustomViews(this.$j, this.$e, bp);
              e.resolve(this.$3());
            })
          );
          this.$e.sendCommand(Object).call(this.$e, bn, bo);
      ...
      },
      {
        ...
        $1: function (e, bn, bo, bp, bq) {
          ...
          var bv = bu.$5();
          if (e.$d()._has(bv)) {
            bv = c.buildCustomViewKeyForDuplicate(bu.$5(), bp.owner.username);
          }
          e.$d()._add(bv, bu.$3());
          if (e.$i()._has(bv)) {
            e.$i()._remove(bv);
      ...
      },
      {
        ...
        $n: function (e) {
          var bn = new (ss.makeGenericType(tab.CommandReturnHandler$1, [
            ...
            function (bo, bp) {
              throw tab._TableauException.createInternalError(bp);
            }
          );
          this.$q(Object).call(this, null, bn);
        },
      ...
      },
      {
        ...
        $O: function (e) {
          ...
          var bo = ss.mkdel(this, function () {
            c._processCustomViews(this.$1x, this.$1o, bn);
          });
        ...
        $N: function (e) {
          var bn = JSON.parse(e.get_data());
          if (ss.isNullOrUndefined(this.$1x)) {
            this.$1x = new o(this, this.$1o, null);
          }
          if (ss.isValue(this.$1x)) {
            c._processCustomViewUpdate(this.$1x, this.$1o, bn, true);
          }
          if (!ss.staticEquals(this.$1$8, null)) {
